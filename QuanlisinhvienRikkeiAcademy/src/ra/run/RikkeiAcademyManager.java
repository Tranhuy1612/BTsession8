...
public class RikkeiAcademyManager {
    ...
    public static void addNewStudent() {
        ...
        for (int i = 0; i < n; i++) {
            ...
            newStudent.inputData(classController.getAll(), subjectController.getAll());
...
//    public static void editInformationStudent(@org.jetbrains.annotations.NotNull Student student) {
//        student.inputData();
...
//    public static void editInformationTeacher(@NotNull Teacher teacher) {
//        teacher.inputData();
